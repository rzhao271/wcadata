# Unpopular events 
# number of solvers with at least one valid time
# Bar chart
# DV: number of WCA competitors with at least one valid single for id in IV
# IV: puzzle IDs 555, minx, 666, 777, sq1, clock
...
event_ids = ["555", "666", "777", "minx", "sq1", "clock"]
event_counts = dict()
...
ax.set_aspect('auto')
plt.savefig(f"{img_dir}/unpop-counts.png", bbox_inches='tight')
